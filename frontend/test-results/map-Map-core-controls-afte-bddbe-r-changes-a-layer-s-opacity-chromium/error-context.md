...
- Name: map.spec.js >> Map: core controls after memoization/throttling changes >> opacity slider (gear popover) changes a layer's opacity
- Location: tests/e2e/map.spec.js:59:3
