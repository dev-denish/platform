...
- Name: map.spec.js >> Map: core controls after memoization/throttling changes >> pixel inspect (Identify): clicking the map opens a popup with a layer row
- Location: tests/e2e/map.spec.js:92:3
