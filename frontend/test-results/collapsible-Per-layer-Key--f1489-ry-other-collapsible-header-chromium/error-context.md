...
- Name: collapsible.spec.js >> Per-layer Key Metrics section >> a layer's own metrics header has aria-expanded, like every other collapsible header
- Location: tests/e2e/collapsible.spec.js:115:3
