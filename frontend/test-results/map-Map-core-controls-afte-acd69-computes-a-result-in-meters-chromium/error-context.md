...
- Name: map.spec.js >> Map: core controls after memoization/throttling changes >> measure: distance tool computes a result in meters
- Location: tests/e2e/map.spec.js:68:3
