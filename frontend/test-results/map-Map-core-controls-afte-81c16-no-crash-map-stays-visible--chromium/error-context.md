...
- Name: map.spec.js >> Map: core controls after memoization/throttling changes >> Extent button re-fits the map (no crash, map stays visible)
- Location: tests/e2e/map.spec.js:29:3
