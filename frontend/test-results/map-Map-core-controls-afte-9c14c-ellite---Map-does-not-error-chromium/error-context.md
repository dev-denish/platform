...
- Name: map.spec.js >> Map: core controls after memoization/throttling changes >> basemap switch (Satellite <-> Map) does not error
- Location: tests/e2e/map.spec.js:119:3
