...
- Name: map.spec.js >> Map: core controls after memoization/throttling changes >> fullscreen toggle enters and exits fullscreen
- Location: tests/e2e/map.spec.js:106:3
