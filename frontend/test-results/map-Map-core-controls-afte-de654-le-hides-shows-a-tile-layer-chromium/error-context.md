...
- Name: map.spec.js >> Map: core controls after memoization/throttling changes >> layer visibility checkbox toggle hides/shows a tile layer
- Location: tests/e2e/map.spec.js:49:3
