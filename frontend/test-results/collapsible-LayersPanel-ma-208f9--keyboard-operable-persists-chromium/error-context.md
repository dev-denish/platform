...
- Name: collapsible.spec.js >> LayersPanel (map) collapsible groups >> per-kind group ("Classified imagery") collapses, keyboard-operable, persists
- Location: tests/e2e/collapsible.spec.js:104:3
