...
- Name: map.spec.js >> Map: core controls after memoization/throttling changes >> measure: area tool computes a result in hectares
- Location: tests/e2e/map.spec.js:80:3
